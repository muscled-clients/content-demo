...
export default function FifthSlide() {
  ...
  const features = [
    ...
    { 
      icon: '👥', 
      title: 'Collaboration',
      description: 'Work seamlessly with teams worldwide'
    },
    { 
      icon: '📝', 
      title: 'Documentation',
      description: 'Keep code and docs together'
    },
    { 
      icon: '🚀', 
      title: 'Deployment',
      description: 'Ship directly from repositories'
    },
  ];
  ...
  return (
    <div className="w-full h-full flex items-center justify-center relative overflow-hidden bg-gray-950">
      ...
      <div className="max-w-5xl w-full px-8 z-10">
        {/* Main GitHub Box - Larger and Centered */}
        <motion.div
          ...
          >
            ...
            >
              <p className="text-gray-300 text-lg italic">
                "GitHub transforms code from isolated files into living, collaborative projects"
              </p>
            </motion.div>
          </motion.div>
        )}
